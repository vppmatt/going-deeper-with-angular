...
highlightTopSongs() {
  this.topScore = this.songs.map((song) => song.votes).sort((a, b) => b - a)[0];
 
}

replaceSong() {
  this.songs[0].title = "Deeper shade of blue";
  //this.songs[0]  = {...this.songs[0], title: "Deeper shade of blue"};
}
